...
interface Props {
  ...
  choiceCount: number;
  /** Hidden for Listen (pictures only); shown where reading is the point. */
  showLabels?: boolean;
}

export function HutPlayer({ childId, themeId, skill, questions, choiceCount, showLabels = false }: Props) {
  const router = useRouter();
  const engine = useHutEngine({ questions, choiceCount, skill, themeId });
